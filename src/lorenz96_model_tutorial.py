...
Code from: 
Balwada et al. (2023). Learning Machine Learning with Lorenz-96. Authorea Preprints.
https://github.com/m2lines/L96_demo
"""
...
def L96_2t_xdot_ydot(X, Y, F, h, b, c):
    ...
    Xdot = np.roll(X, 1) * (np.roll(X, -1) - np.roll(X, 2)) - \
        X + F - hcb * Ysummed
    Ydot = (
